.include "macros.inc"
.file "auto_07_804D7DCC_data"

# 0x804D7DCC..0x804D900C | size: 0x1240
.data
.balign 4

# .data:0x0 | 0x804D7DCC | size: 0x10
.obj String_"EmberMgr_Ember", global
	.string "EmberMgr::Ember"
.endobj String_"EmberMgr_Ember"

# .data:0x10 | 0x804D7DDC | size: 0x1C
...
# .data:0x2C | 0x804D7DF8 | size: 0x2C
...
# .data:0x84 | 0x804D7E50 | size: 0x2C
...
# .data:0xE4 | 0x804D7EB0 | size: 0x40
...
# .data:0x124 | 0x804D7EF0 | size: 0x38
...
# .data:0x15C | 0x804D7F28 | size: 0x20
...
# .data:0x17C | 0x804D7F48 | size: 0x528
...
# .data:0x6A4 | 0x804D8470 | size: 0xC
...
# .data:0x6D0 | 0x804D849C | size: 0x58
...
# .data:0x728 | 0x804D84F4 | size: 0x84
...
# .data:0x7AC | 0x804D8578 | size: 0x84
...
# .data:0x830 | 0x804D85FC | size: 0x1C
...
# .data:0x84C | 0x804D8618 | size: 0x28
...
# .data:0x874 | 0x804D8640 | size: 0x30
...
# .data:0x8A4 | 0x804D8670 | size: 0x18
...
# .data:0x8BC | 0x804D8688 | size: 0xC
...
# .data:0x914 | 0x804D86E0 | size: 0xC
...
# .data:0x920 | 0x804D86EC | size: 0x18
...
# .data:0x938 | 0x804D8704 | size: 0xC
...
# .data:0x944 | 0x804D8710 | size: 0x48
...
# .data:0x98C | 0x804D8758 | size: 0x48
...
# .data:0x9D4 | 0x804D87A0 | size: 0xC
...
# .data:0x9E0 | 0x804D87AC | size: 0xC
...
# .data:0x9EC | 0x804D87B8 | size: 0xC
...
# .data:0x9F8 | 0x804D87C4 | size: 0xC
...
# .data:0xA20 | 0x804D87EC | size: 0xC
...
# .data:0xA2C | 0x804D87F8 | size: 0x10
...
# .data:0xA3C | 0x804D8808 | size: 0xC
...
# .data:0xA48 | 0x804D8814 | size: 0xC
.obj String_"AC_RUN_HURI", global
	.string "AC_RUN_HURI"
.endobj String_"AC_RUN_HURI"

# .data:0xA54 | 0x804D8820 | size: 0x10
...
# .data:0xA64 | 0x804D8830 | size: 0x10
...
# .data:0xA74 | 0x804D8840 | size: 0xC
.obj String_"AC_PUSH_END", global
	.string "AC_PUSH_END"
.endobj String_"AC_PUSH_END"

# .data:0xA80 | 0x804D884C | size: 0x10
...
# .data:0xA90 | 0x804D885C | size: 0x14
...
# .data:0xAA4 | 0x804D8870 | size: 0x10
...
# .data:0xAB4 | 0x804D8880 | size: 0x14
...
# .data:0xAC8 | 0x804D8894 | size: 0xC
...
# .data:0xAD4 | 0x804D88A0 | size: 0xC
...
# .data:0xAE0 | 0x804D88AC | size: 0xC
...
# .data:0xAEC | 0x804D88B8 | size: 0x14
...
# .data:0xB00 | 0x804D88CC | size: 0x14
...
# .data:0xB14 | 0x804D88E0 | size: 0x18
...
# .data:0xB2C | 0x804D88F8 | size: 0x18
...
# .data:0xB70 | 0x804D893C | size: 0x18
...
# .data:0xBA8 | 0x804D8974 | size: 0xC
...
# .data:0xBB4 | 0x804D8980 | size: 0xC
...
# .data:0xBC0 | 0x804D898C | size: 0xC
...
# .data:0xBCC | 0x804D8998 | size: 0xC
...
# .data:0xBD8 | 0x804D89A4 | size: 0xC
...
# .data:0xBE4 | 0x804D89B0 | size: 0x10
...
# .data:0xC18 | 0x804D89E4 | size: 0xC
...
# .data:0xC24 | 0x804D89F0 | size: 0xC
...
# .data:0xC30 | 0x804D89FC | size: 0x10
...
# .data:0xC40 | 0x804D8A0C | size: 0xC
...
# .data:0xC4C | 0x804D8A18 | size: 0x10
...
# .data:0xC5C | 0x804D8A28 | size: 0x10
...
# .data:0xC6C | 0x804D8A38 | size: 0xC
.obj String_"AC_FLAT_END", global
	.string "AC_FLAT_END"
.endobj String_"AC_FLAT_END"

# .data:0xC78 | 0x804D8A44 | size: 0x14
...
# .data:0xC8C | 0x804D8A58 | size: 0x14
...
# .data:0xCE0 | 0x804D8AAC | size: 0x10
...
# .data:0xCF0 | 0x804D8ABC | size: 0x14
...
# .data:0xD04 | 0x804D8AD0 | size: 0x10
...
# .data:0xD14 | 0x804D8AE0 | size: 0x10
...
# .data:0xD24 | 0x804D8AF0 | size: 0x10
...
# .data:0xD34 | 0x804D8B00 | size: 0x10
...
# .data:0xD44 | 0x804D8B10 | size: 0x14
...
# .data:0xD58 | 0x804D8B24 | size: 0x14
...
# .data:0xD6C | 0x804D8B38 | size: 0x14
...
# .data:0xD80 | 0x804D8B4C | size: 0x10
...
# .data:0xDB0 | 0x804D8B7C | size: 0x10
...
# .data:0xDC0 | 0x804D8B8C | size: 0x10
...
# .data:0xDD0 | 0x804D8B9C | size: 0xC
.obj String_"AC_GRE_FIRE", global
	.string "AC_GRE_FIRE"
.endobj String_"AC_GRE_FIRE"

# .data:0xDDC | 0x804D8BA8 | size: 0x14
...
# .data:0xDF0 | 0x804D8BBC | size: 0x14
...
# .data:0xE04 | 0x804D8BD0 | size: 0x14
...
# .data:0xE18 | 0x804D8BE4 | size: 0xC
.obj String_"AC_GRE_PUSH", global
	.string "AC_GRE_PUSH"
.endobj String_"AC_GRE_PUSH"

# .data:0xE24 | 0x804D8BF0 | size: 0xE0
...
# .data:0xF04 | 0x804D8CD0 | size: 0x1C
...
# .data:0xF20 | 0x804D8CEC | size: 0x1C
...
# .data:0xF3C | 0x804D8D08 | size: 0x2C
...
# .data:0xF68 | 0x804D8D34 | size: 0x1C
...
# .data:0xF84 | 0x804D8D50 | size: 0x98
...
# .data:0x101C | 0x804D8DE8 | size: 0x10
...
# .data:0x102C | 0x804D8DF8 | size: 0x38
...
# .data:0x1064 | 0x804D8E30 | size: 0x34
...
# .data:0x1098 | 0x804D8E64 | size: 0x30
...
# .data:0x10C8 | 0x804D8E94 | size: 0x24
...
# .data:0x10EC | 0x804D8EB8 | size: 0xC
...
# .data:0x10F8 | 0x804D8EC4 | size: 0x18
...
# .data:0x1110 | 0x804D8EDC | size: 0xC
...
# .data:0x111C | 0x804D8EE8 | size: 0x18
...
# .data:0x1134 | 0x804D8F00 | size: 0x18
...
# .data:0x114C | 0x804D8F18 | size: 0x64
...
# .data:0x11B0 | 0x804D8F7C | size: 0x3C
...
# .data:0x11EC | 0x804D8FB8 | size: 0xC
...
# .data:0x11F8 | 0x804D8FC4 | size: 0x28
...
# .data:0x1220 | 0x804D8FEC | size: 0x10
...
# .data:0x1230 | 0x804D8FFC | size: 0x10
